...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering
	\includegraphics[width=1.\linewidth]{pics/s1l6_1.png}
\end{wrapfigure}
\underline{\emph{Физический смысл}}:  ``метод распределения волн''.\\
...
\begin{wrapfigure}[8]{l}{0.3\textwidth}
	\centering
	\includegraphics[width=1.\linewidth]{pics/s1l6_2.png}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{r}{0.3\textwidth}
	\centering
	\includegraphics[width=1.\linewidth]{pics/s1l6_3.png}
\end{wrapfigure}
\begin{note}
